...
// source: redchain/redchain/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_44fc00e1c50dad44, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_44fc00e1c50dad44, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "redchain.redchain.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "redchain.redchain.QueryParamsResponse")
}

func init() { proto.RegisterFile("redchain/redchain/query.proto", fileDescriptor_44fc00e1c50dad44) }

var fileDescriptor_44fc00e1c50dad44 = []byte{
	// 279 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x2d, 0x4a, 0x4d, 0x49,
	...
	0x2a, 0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0xe1, 0x64, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xf5,
	0xe6, 0x4a, 0x94, 0xdb, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/redchain.redchain.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/redchain.redchain.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "redchain.redchain.Query",
	...
	Metadata: "redchain/redchain/query.proto",
}
